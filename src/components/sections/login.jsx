...
const LoginSection = () => {
    ...
    return (
        <div className="py-20 lg:min-h-screen lg:w-1/2 w-full flex items-center justify-center flex-col bg-blue-500 text-white">
            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-semibold mb-10 sm:mb-12 md:mb-14 lg:mb-16 2xl:mb-20">Leleo Developer...</h3>
            ...
            <div className="w-11/12 lg:w-10/12 xl:w-9/12 2xl:w-8/12 text-right mb-10 sm:mb-12 md:mb-14 lg:mb-16 2xl:mb-20 text-xs sm:text-sm md:text-base lg:text-lg">
                <p className="cursor-pointer" onClick={passwordType === false ? () => setPasswordType(true) : () => setPasswordType(false)}>Click to {passwordType === false ? 'show' : 'hide'} your Password</p>
