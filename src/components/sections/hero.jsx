...
const HeroSection = ({ title, subtitle, buttontext, onClick }) => {
  return (
    <div className="py-20 lg:min-h-screen lg:w-1/2 w-full flex items-center lg:items-start justify-center flex-col text-center lg:text-left px-5 md:px-10 lg:px-28 xl:px-32 2xl:px-40 text-blue-500 bg-white">
